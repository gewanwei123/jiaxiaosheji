...
const teamData = {
  management: [
    {
      ...
      description: '从2013年开始进行机动车驾驶人考试场地和机动车驾驶员培训教练场地设计规划工作，拥有丰富的驾校规划和管理经验，对行业法规和标准有深入研究。在创办工作室前，作为自由团队负责人已成功服务超过200个驾校规划项目。2025年4月创立郑州市中原区驾维素信息服务工作室，致力于推动驾培行业规范化、专业化发展。',
  ...
  teamCulture: {
    title: '我们的团队文化',
    description: '郑州市中原区驾维素信息服务工作室虽然刚刚成立，但我们团队成员凭借丰富的行业经验，组建了一支专业、高效、富有创新精神的团队，秉持"客户至上、专业为本、精益求精"的理念。每位成员都拥有专业技能，通过跨学科合作，为客户提供最优质的服务。',
    values: [
